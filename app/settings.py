...
SECRET_KEY = 'tczp9-z&w3%$zy-_%en=3$!le57it0p-x*tzh=y0g*k^z2mbyf'
...
TWITTER_CONSUMER_KEY = os.environ.get('TWITTER_CONSUMER_KEY', 'rwn8cv0p7by6')
TWITTER_CONSUMER_SECRET = os.environ.get('TWITTER_CONSUMER_SECRET', 'ON8Utk33QuR6JnRJ')
...
GOOGLE_OAUTH_EXTRA_SCOPE = ['https://www.google.com/m8/feeds', 'userinfo.email','userinfo.profile']
